...
# #
# # Net_w8bit
# # an 8-bit weight quantized network model in CC and CA stage.
...
class Net_w8bit(nn.Module):
    def __init__(self, cfg):
        super(Net_w8bit, self).__init__()
        angRes = 7
        ...
        layers_agg.append(
            nn.Sequential(
                ...
                QuantConv2d(in_channels=AC, out_channels=ACout, kernel_size=1, stride=1, bias=False, 
                            weight_quant=CommonIntWeightPerChannelQuant, weight_bit_width=self.awbit)))
